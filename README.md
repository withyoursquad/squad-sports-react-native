...
npm install react-native-gesture-handler react-native-safe-area-context \
  ...
  @gorhom/bottom-sheet recoil expo-secure-store expo-av expo-image \
...
- React Native 0.72+
- React 18+
- iOS 16+ / Android SDK 24+ (Android 7.0)
- Expo SDK 50+ (if using Expo)

## Get Your Partner Credentials

The Squad Sports SDK is distributed to partners through a direct onboarding process. Your partner ID and API key are issued by your Squad partner manager.

To start an integration or request credentials, email **[support@squadforsports.com](mailto:support@squadforsports.com)**.
