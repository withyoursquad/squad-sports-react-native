...
import { AnalyticsTracker, DeviceInfo } from '@squad-sports/core';
...
export function SquadExperience({
      ...
      try {
        ...
        if (pushToken) {
          ...
          const info = new DeviceInfo({
            ...(platform === 'ios' ? { apnsToken: pushToken } : { fcmToken: pushToken }),
          });
          sdk.apiClient.updateDeviceInfo(info);
        }
  ...
  if (!resolvedConfig) {
    return <SplashScreen brandName={partnerId} />;
  }
